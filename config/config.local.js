...
const redisPassword = 'redis!@#root';

const logPath = './logs/measure-webapi';
...
module.exports = appInfo => {
  ...
  config.nacos = {
    ...
    'micro-consulting-ms': 'http://50400.ms.product.kapboo.com:8888',
  };
